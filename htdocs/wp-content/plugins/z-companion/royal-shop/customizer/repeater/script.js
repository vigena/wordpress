		...
		function () {
			...
			th.find( '.customizer-repeater-general-control-repeater-container' ).each(
				function () {
					...
					if (text !== '' || image_url !== '' || logo_image_url !== '' || title !== '' || price !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '') {
						values.push(
							{
...
jQuery( document ).ready(
	function () {
		...
		theme_conrols.on(
			'change', '.customizer-repeater-image-choice', function () {
				...
				if (jQuery( this ).val() === 'customizer_repeater_logo_image') {
					jQuery( this ).parent().parent().find( '.social-repeater-general-control-icon' ).hide();
					jQuery( this ).parent().parent().find( '.customizer-repeater-logo-image-control' ).show();
					jQuery( this ).parent().parent().find( '.customizer-repeater-color-control' ).prev().prev().hide();
					jQuery( this ).parent().parent().find( '.customizer-repeater-color-control' ).hide();
		...
		media_upload( '.customizer-repeater-logo-custom-media-button' );
		jQuery( '.custom-logo-media-url' ).on(
			'change', function () {
				customizer_repeater_refresh_general_control_values();
				return false;
			}
	 ...
	 */
			...
			'click', '.customizer-repeater-new-field', function () {
				...
				if (typeof th !== 'undefined') {
					...
					if (typeof field !== 'undefined') {
						...
						/*Remove value from logo media field*/
						field.find( '.custom-logo-media-url' ).val( '' );
		...
		theme_conrols.on(
			'keyup', '.customizer-repeater-price-control', function () {
				customizer_repeater_refresh_general_control_values();
			}
		);

		theme_conrols.on(
			'keyup', '.customizer-repeater-number-control', function () {
				customizer_repeater_refresh_general_control_values();
			}
		);

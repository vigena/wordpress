...
class ThemeHunk_Notify{
	...
	function enqueue(){
		wp_enqueue_style( 'owl.carousel', Z_COMPANION_PLUGIN_DIR_URL.'notify/assets/css/owl.carousel.css', array(), '1.0.0' );
		wp_enqueue_style( 'hunk-companion-notice', Z_COMPANION_PLUGIN_DIR_URL.'notify/assets/css/notice.css', array(), '1.0.0' );
		...
		wp_enqueue_script( 'hunk-companion-notify', Z_COMPANION_PLUGIN_DIR_URL.'notify/assets/js/themehunk-notify.js', array( 'jquery' ), '',false );
